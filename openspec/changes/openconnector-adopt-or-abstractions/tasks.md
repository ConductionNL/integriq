...
- [~] Phase complete <!-- BLOCKED-ON-OR: 7 PROP_* GUID constants still live in lib/Service/RuleService.php:153-159 (verified at branch time). Awaiting `RegisterResolverService::resolveProperty($schemaSlug, $propertySlug)` to land in OpenRegister. -->
