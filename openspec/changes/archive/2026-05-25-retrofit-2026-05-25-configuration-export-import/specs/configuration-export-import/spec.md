...
requirement Notes record it rather than silently "fixing" it.

See ADR-015 (slug-translation contract) and ADR-007 (Source credentials stored
plaintext) for the governing decisions.
