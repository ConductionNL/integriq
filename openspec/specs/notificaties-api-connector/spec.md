...
@e2e exclude backend ZGW Notificaties API subscriber/publisher (abonnement lifecycle, callback auth,
publish body mapping — no browser UI surface beyond the Abonnementen config page) — covered by
