...
## Requirements
### Requirement: OAuth Client Credentials and Password token fetch (REQ-001)
...
### Requirement: Decos non-standard OAuth token fetch (REQ-003)
...
### Requirement: Twig authentication runtime — token injection into sources (REQ-004)
...
### Requirement: Twig mapping runtime — encoding, mapping execution, file lookup, slug (REQ-005)
