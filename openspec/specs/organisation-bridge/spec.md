...
### Requirement: OR-availability predicate and unavailable-shape returns (REQ-002)
...
### Requirement: User organisation statistics with availability fallback (REQ-003)
...
### Requirement: Set active organisation for the current user (REQ-004)
...
### Requirement: Read active and list user organisations as jsonSerialize arrays (REQ-005)
