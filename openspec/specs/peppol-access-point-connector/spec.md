...
**OpenSpec changes**
- `peppol-access-point-connector` (done) — introduces the participant/SMP
  ...
  status CloudEvent emission, and the signed inbound receive webhook.
  Archived at `openspec/changes/archive/2026-07-12-peppol-access-point-connector/`.
