---
sidebar_position: 1
title: Open OpenConnector for the first time
description: Open OpenConnector, find your way around the navigation, and confirm the integration layer is wired up.
---
...
1. Open the Nextcloud app menu in the top bar and pick **Connector**. You land on the OpenConnector dashboard.
   ...
   ![OpenConnector dashboard](/screenshots/tutorials/user/01-first-launch-01.png)
...
3. Open the left-hand navigation. The entries map one-to-one onto the OpenConnector concept model: **Sources**, **Endpoints**, **Consumers**, **Mappings**, **Jobs**, **Cloud Events**, **Synchronization**, **Rules**, **Import**. Each top-level item has a *Logs* sub-entry where every call is recorded for audit and debugging.
   ...
   ![OpenConnector navigation](/screenshots/tutorials/user/01-first-launch-03.png)
...
- [Synchronizations feature](../../features/synchronizations.md) — how OpenConnector moves data between systems.
- [Configuration management](../../features/configuration-management.md) — import / export of full OpenConnector configurations.
