 ...
 *
 * Service for orchestrating source connections and data mappings in OpenConnector.
 * Handles MongoDB operations, OpenRegister integration, and object mapper routing.
 *
 * @category Service
...
/**
 * Orchestrates source connections and schema-level data mappings.
 *
 * Named SourceMappingService to distinguish from OR's generic ObjectService.
 * Renamed from ObjectService per the OR-abstraction adoption audit (2026-05-03).
 *
