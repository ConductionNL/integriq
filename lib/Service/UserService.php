...
class UserService
{
     ...
     * @param IDBConnection             $dbConnection              The database connection (injected; replaces \OC::$server->getDatabaseConnection())
     * @param IFactory                  $l10nFactory               The L10N factory (injected; replaces \OC::$server->getL10NFactory())
     */
