<?php
/**
 * Integriq DemoDataService.
 *
 * Imports `lib/Settings/integriq_mock_register.json` — a `type: mock` descriptor generated from this
...
class DemoDataService {
	 ...
	 * @var string
	 */
	private const DESCRIPTOR = '/lib/Settings/integriq_mock_register.json';
