...
/**
 * Integriq DUO Verzuimloket Translation Exception.
 *
 * Raised by VerzuimloketEnvelopeTranslator and
 * VerzuimloketAcknowledgementTranslator when a required field is
 * missing/empty, or a rendered envelope still contains an unresolved
 * template marker — the literal-leak guard (mirrors
 * RodTranslationException).
 *
 * @category Exception
