...
// path-form deep-link (`/apps/openconnector/consumers`) is ignored and lands
// on the dashboard; the hash form (`/apps/openconnector/#/consumers`) renders
// the target page. APP_BASE carries the `/#`.
