...
use OCA\Integriq\Controller\SetupController;
use OCA\Integriq\Service\DemoDataService;
use OCP\IAppConfig;
use OCP\IRequest;
...
class SetupControllerTest extends TestCase {
	...
	public function testSkippingIsAnAnswerAndIsRecorded(): void {
		...
		$this->appConfig->expects($this->once())
			...
			->with('integriq', 'demo_data_decided', 'skipped');
	...
	public function testInstallReportsHowMuchLanded(): void {
		...
		$this->appConfig->expects($this->once())
			->method('setValueString')
			->with('integriq', 'demo_data_decided', 'installed');
